...
const About = () => {
  return (
    <Helmet title="About">
      ...
      <section className="about__page-section" style={{zIndex:30, position:"relative"}}>
        <Container>
          <Row>
            <Col lg="6" md="6" sm="12">
            ...
            <Col lg="6" md="6" sm="12">
              ...
              <h2 className="section__title" style={{fontWeight:'bold', color:"#0f3443"}}>We Are</h2>
                ...
                <h2 className="section__title" style={{fontWeight:'bold', color:"#0f3443"}}>Mission</h2>
      ...
      <section style={{marginTop:"5rem", zIndex:30, position:"relative"}}>
        <Container>
          <Row>
            <Col lg="12" className="mb-5 text-center">
              <h6 className="section__subtitle">Why</h6>
              <h2 className="section__title" style={{color:"#0f3443"}}>MotoHire?</h2>
            </Col>
            <OurMembers />
          </Row>
        </Container>
